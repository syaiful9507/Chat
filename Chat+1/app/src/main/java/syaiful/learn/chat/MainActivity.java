...
import syaiful.learn.chat.adapter.ChatFirebaseAdapter;
import syaiful.learn.chat.adapter.ClickListenerChatFirebase;
import syaiful.learn.chat.model.ChatModel;
import syaiful.learn.chat.model.FileModel;
import syaiful.learn.chat.model.MapModel;
import syaiful.learn.chat.model.UserModel;
import syaiful.learn.chat.util.Util;
import syaiful.learn.chat.view.FullScreenImageActivity;
import syaiful.learn.chat.view.LoginActivity;
...
//                photoCameraIntent();
    ...
    private void sendFileFirebase(StorageReference storageReference, final Uri file){
        if (storageReference != null){
            ...
            final String name = df.format("yyyy-MM-dd_hhmmss", new Date()).toString();
    ...
    private void photoCameraIntent(){
        android.text.format.DateFormat df = new android.text.format.DateFormat();
        String nomeFoto = df.format("yyyy-MM-dd_hhmmss", new Date()).toString();
